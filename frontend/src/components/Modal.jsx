...
//                     <h3 className='text-lg font-medium text-medium text-gray-900 dark:text-white'>
//                         {title}
//                     </h3>
            ...
            <div className='relative p-4 w-full max-w-2xl max-h-full'>
                <div className='relative rounded-lg shadow-sm  bg-white'>
                    <div className='flex items-center justify-between p-4 md:p-5 border-b rounded-t border-gray-200 '>
                        ...
                        <button
                            type='button'
                            className='text-gray-800  bg-gray-100 hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 inline-flex justify-center items-center cursor-pointer'
                            onClick={onClose}
                        >
                            ✕
                        </button>
